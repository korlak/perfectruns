...
<div class="login">
    ...
    <h1>Register to PerfrectRuns</h1>
    <form action="" method="post">
        ...
        <div class="container">
            ...
            <input type="text" placeholder="Enter Username" name="login" value="<?= $this->controller->post->login ?>"
                   required>
            ...
            <input type="text" placeholder="Enter Nickname" name="nickname"
                   value="<?= $this->controller->post->nickname ?>" required>
